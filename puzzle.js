...
знания1.добавить(new Эквивалентность(new И(БЛжец, AЛжец), АРыцарь))
...
знания2.добавить(new Эквивалентность(new Или(new И(БЛжец, AЛжец),new И(БРыцарь, АРыцарь)), АРыцарь))
знания2.добавить(new Эквивалентность(new Или(new И(БРыцарь, AЛжец),new И(БЛжец, АРыцарь)), БРыцарь))
